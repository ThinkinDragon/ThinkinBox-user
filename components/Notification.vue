...
<!-- <NotificationGroup group="success">
  ...
  >
    <div class="w-full max-w-sm">
      ...
      >
        <div
          class="flex w-full max-w-sm mx-auto mt-4 overflow-hidden rounded-lg shadow-lg bg-secondary-100 dark:bg-secondary-800"
          v-for="notification in notifications"
          :key="notification.id"
        >
          <div class="flex items-center justify-center w-12 bg-accent">
...
<van-overlay :show="loading">
  <div class="relative" >
    <ClientOnly>
    <Vue3Lottie class="absolute inset-0 flex items-center justify-center h-screen" :animationData="DogJSON" :height="200" :width="200" />
    </ClientOnly>
  </div>
</van-overlay>
</template>
...
<style>
:root {
--van-overlay-z-index	: 9999 !important;
--van-overlay-background-color: rgba(0,0,0,.3) !important;
}
</style>