          ...
          <TabGroup>
            ...
            <TabPanels class="mt-2">
              ...
              <div class="flex flex-col space-y-4 justify-start">
                <div class="relative inline-flex h-12 items-center justify-start rounded-lg border bg-gray-100 dark:bg-gray-800 p-4">
                ...
                <div class="inline-flex items-start justify-start space-x-2">
                  <div class="flex items-center justify-center space-x-2 rounded-full bg-white dark:bg-gray-900 px-4 py-2 shadow">
